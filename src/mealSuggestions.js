const mealSuggestions = {
  breakfast: [
    ...
    { name: "Bánh bao xá xíu (1 cái)", calories: 180 },
    { name: "Bún thịt nướng (1 tô)", calories: 400 },
    { name: "Xôi lạc (1 bát)", calories: 250 },
    { name: "Trứng vịt lộn (1 quả)", calories: 120 },
    { name: "Súp cua (1 chén)", calories: 200 },
    { name: "Cơm bò kho (1 đĩa)", calories: 600 },
    { name: "Cá kho riềng (1 phần)", calories: 400 },
    { name: "Gỏi ngó sen (1 phần)", calories: 200 },
    { name: "Chả lá lốt (1 phần)", calories: 450 },
    { name: "Nem nướng (1 phần)", calories: 300 },
    { name: "Bún cá rô đồng (1 tô)", calories: 350 },
    { name: "Lẩu dê (1 phần)", calories: 700 },
    { name: "Pancake (Mỹ)", calories: 350 },
    { name: "Croissant (Pháp)", calories: 230 },
    { name: "Arepa (Venezuela)", calories: 300 },
    { name: "Miso Soup (Nhật Bản)", calories: 80 },
    { name: "Dim sum (Trung Quốc)", calories: 250 },
    { name: "Nước ép cà chua (1 ly)", calories: 50 },
    { name: "Sữa ngô (1 cốc)", calories: 100 },
  ...
  lunch: [
    ...
    { name: "Sushi (Nhật Bản)", calories: 300 },
    { name: "Paella (Tây Ban Nha)", calories: 500 },
    { name: "Pizza Margherita (Ý)", calories: 600 },
    { name: "Shawarma (Trung Đông)", calories: 450 },
    { name: "Tacos (Mexico)", calories: 350 },
  ...
  dinner: [
    ...
    { name: "Cá basa nướng (1 phần)", calories: 350 },
    { name: "Canh cua (1 bát)", calories: 200 },
    { name: "Đậu hũ chiên sả ớt (1 phần)", calories: 250 },
    { name: "Sườn ram mặn (1 phần)", calories: 400 },
    { name: "Cơm chiên hải sản (1 đĩa)", calories: 550 },
    { name: "Cháo ếch Singapore (1 phần)", calories: 400 },
    { name: "Lẩu bò nhúng dấm (1 phần)", calories: 600 },
    { name: "Kimchi Jjigae (Hàn Quốc)", calories: 300 },
    { name: "Couscous (Morocco)", calories: 400 },
    { name: "Biryani (Ấn Độ)", calories: 550 },
    { name: "Pad Thai (Thái Lan)", calories: 450 },
    { name: "Grilled Salmon (Na Uy)", calories: 350 },
  ...
  snacks: [
    ...
    { name: "Sinh tố dâu (1 ly)", calories: 180 },
    { name: "Bánh crepe sầu riêng (1 cái)", calories: 250 },
    { name: "Kẹo dừa (1 phần nhỏ)", calories: 150 },
    { name: "Bánh tiêu (1 cái)", calories: 200 },
    { name: "Baklava (Thổ Nhĩ Kỳ)", calories: 200 },
    { name: "Gelato (Ý)", calories: 180 },
    { name: "Churros (Tây Ban Nha)", calories: 250 },
    { name: "Macaron (Pháp)", calories: 150 },
    { name: "Poutine (Canada)", calories: 350 },
    { name: "Nước sâm (1 ly)", calories: 50 },
    { name: "Bắp luộc (1 trái)", calories: 100 },
    { name: "Sữa bắp (1 ly)", calories: 120 },
